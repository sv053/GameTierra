...
class UserTest {
    ...
    @Test
    void addGame() {
        final User user = new User(null, null, SampleData.TIERS.get(1), BigDecimal.valueOf(87.5));
    ...
    void withdrawBalance() {
        ...
        final User user = new User(null, null, SampleData.TIERS.get(4), balance);
    ...
    void depositBalance() {
        ...
        final User user = new User(null, null, SampleData.TIERS.get(2), initialBalance);
    ...
    @Test
    void canPay() {
        final User user = new User(null, null, SampleData.TIERS.get(2), BigDecimal.ONE);
    ...
    void hasGame() {
        final Game game = new Game(4, "SKYRIM", BigDecimal.valueOf(87.88d));
        final User user = new User(null, null, SampleData.TIERS.get(1), BigDecimal.valueOf(123.15d));
        user.addGame(game);
    ...
    void doesNotHaveGame() {
        final User user = new User(null, null, SampleData.TIERS.get(1), BigDecimal.valueOf(123));
